...
- [Programação Dinâmica](https://www.youtube.com/channel/UC70mr11REaCqgKke7DPJoLg/) - Antigo Python Café. Canal do [Hallison Paz](https://twitter.com/hallpaz) e da [Kizzy Terra](https://www.instagram.com/kizzy_terra/), focado em desenvolvimento com Python, incluindo playlists de estruturas de dados e programação orientada a objetos com a linguagem. _Tags:`python`_
